...
class SignalementPage<T> extends StatefulWidget {
  ...
  final FutureOr<bool> Function(List<dz.Tuple2<int, ItemModel<T>>> listSelectForms, String? description, PlatformFile? file, XFile? pickedFile) validator;
                            ...
                            if (widget.fileType == FileType.file)
                              ...
                              Input.image(
                                ...
                                onTap: () async {
                                  ...
                                  xfile = await picker.pickImage(source: val == 1 ? ImageSource.camera : ImageSource.gallery);
                                  setState(() {});
                                },
